...
class IdentifierDeclarationListenerTest {
    ...
    @Test
    void method_scope_declaration() throws IOException {
    ...
    @Test
    void file_scope_declaration() throws IOException {
        final AniParser parser = new AniFile(
    ...
    @Test
    void class_scope_declaration() throws IOException {
        final AniParser parser = new AniFile(
    ...
    @Test
    void if_scope_declaration() throws IOException {
        final AniParser parser = new AniFile(
    ...
    @Test
    void while_scope_declaration() throws IOException {
        final AniParser parser = new AniFile(
    ...
    @Test
    void for_scope_declaration() throws IOException {
        final AniParser parser = new AniFile(
    ...
    @Test
    void match_scope_declaration() throws IOException {
        final AniParser parser = new AniFile(
